...
if &background == "light"
    ...
    hi IncSearch guibg=#f4a88a guifg=fg gui=none
    ...
    hi SpecialKey guibg=bg guifg=#944e36 gui=none
    hi StatusLine ctermbg=Black ctermfg=White guibg=#4b5692 guifg=#ffffff gui=bold
    hi StatusLineNC ctermbg=LightGray ctermfg=fg guibg=#808080 guifg=#ffffff gui=bold
    if has("spell")
    ...
    hi VertSplit ctermbg=LightGray ctermfg=fg guibg=#808080 guifg=#ffffff gui=none
    if version >= 700
    ...
    hi Comment guibg=bg guifg=#5b911a gui=none
    hi Constant guibg=bg guifg=#bc720e gui=none
    hi Error guibg=bg guifg=#ca001f gui=none
    hi Identifier guibg=bg guifg=#0f8674 gui=none
    ...
    hi PreProc guibg=bg guifg=#c84d5f gui=none
    hi Special guibg=bg guifg=#944e36 gui=none
    ...
    hi StatusLine ctermbg=LightGray ctermfg=Black guibg=#4b5692 guifg=#ffffff gui=bold
    hi StatusLineNC ctermbg=LightGray ctermfg=Black guibg=#808080 guifg=#ffffff gui=bold
    if has("spell")
    ...
    hi VertSplit ctermbg=LightGray ctermfg=Black guibg=#808080 guifg=#ffffff gui=none
    if version >= 700
    ...
    hi VisualNOS ctermbg=DarkGray ctermfg=Black guibg=bg guifg=#5763a8 gui=bold,underline
